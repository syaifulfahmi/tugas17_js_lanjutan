...
// var ascii = (kalimat3.substr(0,6))

// function charCodeAt(nilai) {
// console.log(nilai.charCodeAt())
// }
...
console.log(kalimat3.charCodeAt(0),"-",kalimat3.charCodeAt(1),"-",kalimat3.charCodeAt(2),"-",kalimat3.charCodeAt(3),"-",kalimat3.charCodeAt(4),"-",kalimat3.charCodeAt(5),"-",kalimat3.charCodeAt(6))
